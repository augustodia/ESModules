export class EditAlunoView {
  ...
  render(aluno) {
    ...
    <div class="input-field col s2">
      ...
      id="nota_${materia}_0" type="number" class="validate" value="${aluno.notas[materia]?.[0]}" />
    </div>
    <div class="input-field col s2">
      <input data-trimestre="1"
      id="nota_${materia}_1" type="number" class="validate" value="${aluno.notas[materia]?.[1]}"/>
    </div>
    <div class="input-field col s2">
      <input data-trimestre="2"
      id="nota_${materia}_2" type="number" class="validate" value="${aluno.notas[materia]?.[2]}"/>
    </div>
    <div class="input-field col s2">
      <input data-trimestre="3"
      id="nota_${materia}_3" type="number" class="validate" value="${aluno.notas[materia]?.[3]}"/>
    </div>
  </div>
    `
      )
